...
async def create_cantine_menu_item(item: CantineMenuItem, ):
...
async def update_cantine_menu_item(item_id: str, item: CantineMenuItem, ):
    cantine_menu_db = CantineMenuDB(db)
...
async def create_hostel_menu_item(item: HostelMenuItem, ):
...
async def update_hostel_menu_item(day: str, item_index: int, item: HostelMenuItem, ):
    hostel_menu_db = HostelMenuDB(db)
